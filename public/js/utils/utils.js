(function() {
    ...
    function initCity(province, city) {
        var _province = ["北京", "广东", "上海", "天津", "重庆", "辽宁", "江苏", "湖北", "四川", "陕西", "河北", "山西", "河南", "吉林", "黑龙江", "内蒙古", "山东", "安徽", "浙江", "福建", "湖南", "广西", "江西", "贵州", "云南", "西藏", "海南", "甘肃", "宁夏", "青海", "新疆", "香港", "澳门", "台湾"];
        var _city = {
            "0": ["请选择"],
            ...
            "天津": ["和平区", "河东区", "河西区", "南开区", "河北区", "红桥区", "塘沽区", "汉沽区", "大港区", "东丽区", "西青区", "北辰区", "津南区", "武清区", "宝坻区", "静海县", "宁河县", "蓟县", "其他"],
            ...
            "河南": ["郑州", "开封", "洛阳", "平顶山", "安阳", "鹤壁", "新乡", "焦作", "濮阳", "许昌", "漯河", "三门峡", "南阳", "商丘", "信阳", "周口", "驻马店", "焦作", "其他"],
        ...
        function getList(arr) {
            ...
            for (var i = 0; i < arr.length; i++) {
                var value = arr[i];
                if (arr[i] == '请选择' || arr[i] == '全国') {
                    value = '0'
                }
                list += '<option value="' + value + '">' + arr[i] + '</option>';
            };
            return list;
        }

        if (city) {
            $(province).html(getList(['请选择'].concat(_province)));
            $(province).on('change', function(e) {
                var cityList = getList(_city[$(e.target).val()]);
                $(city).html(cityList);
            });
        } else {
            $(province).html(getList(['全国'].concat(_province)));
        }
    }
})()
